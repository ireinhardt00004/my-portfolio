...
document.addEventListener('visibilitychange',
    function () {
        if (document.visibilityState === "visible") {
            document.title = "Portfolio | Mark Kevin Maceda";
...
var typed = new Typed(".typing-text", {
    strings: ["frontend web development", "backend web development", "full stack web development"],
    loop: true,
    typeSpeed: 50,
    backSpeed: 25,
    backDelay: 500,
...
(function () {
    ...
    s1.async = true;
    s1.src = 'https://embed.tawk.to/66b9421e0cca4f8a7a74b566/1i51qkhr8';
    s1.charset = 'UTF-8';
